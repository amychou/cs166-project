...
private:
   ...
   * [low, high) out of the tree, using the provided weights.
   */
  static Node* treeFor(const std::vector<double>& weights,
                       std::size_t low, std::size_t high, std::vector<double> &prefixes);
